...
class TransactionSimulator:
    ...
    def __init__(self):
        self.running = False
        self.interval_seconds = 0.5  # 2 transactions per second
    ...
    def start(self):
        ...
        self.thread.start()
        print(f"✓ Simulator started - 2 transactions per second")
        ...
        try:
            with self.lock:
                ...
                with open(self.csv_file, 'a', newline='') as f:
                    fieldnames = [
                        'timestamp', 'txn_id', 'bank', 'method', 'status', 'latency_ms', 'amount'
                    ]
